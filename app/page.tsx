    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section id="about" className="max-w-3xl mx-auto">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-8 border border-gray-200 dark:border-gray-700">
          ...
          {/* Education */}
          <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed tracking-tight mb-8">
            Konkuk University, Department of Physics<br />
            Konkuk University, Convergence Major in Immersive Media Engineering
          </p>
